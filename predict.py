...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_dir", default='./valdata/images',
        help="The image nii directory.")
    parser.add_argument("--pred_dir",default='./pre/test',
        help="The directory for saving predictions.")
    parser.add_argument("--model_path", default='./ouput/trained_models/ckpt_14.pth',
