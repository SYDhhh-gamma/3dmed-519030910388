...
from testdataset import labelDataset, predDataset
...
def evaluate(gt_dir, pred_dir):
    ...
    gt_iter = labelDataset(gt_dir)
    pred_iter = predDataset(pred_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gt_dir", default='./valdata/labels')
    parser.add_argument("--pred_dir",default='./pre/val')
